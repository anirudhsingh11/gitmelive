import { AggregateOptions, AggregateRawReply, AggregateReply } from '@redis/search/dist/commands/AGGREGATE';
export { FIRST_KEY_INDEX, IS_READ_ONLY } from '@redis/search/dist/commands/AGGREGATE';
