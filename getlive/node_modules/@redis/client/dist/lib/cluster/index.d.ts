...
import { RedisCommand, RedisCommandArgument, RedisCommandArguments, RedisCommandRawReply, RedisCommandReply, RedisFunctions, RedisModules, RedisExtensions, RedisScript, RedisScripts, RedisCommandSignature, RedisFunction } from '@redis/client/dist/lib/commands';
import { ClientCommandOptions, RedisClientOptions, RedisClientType, WithFunctions, WithModules, WithScripts } from '@redis/client/dist/lib/client';
import { NodeAddressMap, ShardNode } from '@redis/client/dist/lib/cluster/cluster-slots';
import { EventEmitter } from 'events';
import { RedisClusterMultiCommandType } from '@redis/client/dist/lib/cluster/multi-command';
...
export default class RedisCluster<M extends RedisModules, F extends RedisFunctions, S extends RedisScripts> extends EventEmitter {
    ...
    get slots(): import("@redis/client/dist/lib/cluster/cluster-slots").Shard<M, F, S>[];
    get shards(): import("@redis/client/dist/lib/cluster/cluster-slots").Shard<M, F, S>[];
    get masters(): ShardNode<M, F, S>[];
    get replicas(): ShardNode<M, F, S>[];
    get nodeByAddress(): Map<string, ShardNode<M, F, S> | import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S>>;
    get pubSubNode(): Required<import("@redis/client/dist/lib/cluster/cluster-slots").Node<M, F, S>> | undefined;
    get isOpen(): boolean;
     ...
     */
    getSlotMaster(slot: number): import("@redis/client/dist/lib/cluster/cluster-slots").MasterNode<M, F, S>;
}
export {};
