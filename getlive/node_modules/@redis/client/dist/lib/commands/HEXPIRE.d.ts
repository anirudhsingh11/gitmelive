...
export declare function transformArguments(key: RedisCommandArgument, fields: RedisCommandArgument | Array<RedisCommandArgument>, seconds: number, mode?: 'NX' | 'XX' | 'GT' | 'LT'): import("@redis/client/dist/lib/commands").RedisCommandArguments;
