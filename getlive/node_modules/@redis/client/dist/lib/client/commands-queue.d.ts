...
/// <reference types="node" />
import { RedisCommandArguments, RedisCommandRawReply } from '@redis/client/dist/lib/commands';
import { ChannelListeners, PubSubListener, PubSubType, PubSubTypeListeners } from '@redis/client/dist/lib/client/pub-sub';
