import { CleanSummary } from 'simple-git';
import { StringTask } from 'simple-git/dist/src/lib/types';
...
export declare function cleanWithOptionsTask(mode: CleanMode | string, customArgs: string[]): import("simple-git/dist/src/lib/tasks/task").EmptyTask | StringTask<CleanSummary>;
