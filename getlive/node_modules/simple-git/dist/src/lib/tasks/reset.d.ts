import { Maybe, OptionFlags, Options } from 'simple-git/dist/src/lib/types';
...
export declare function resetTask(mode: Maybe<ResetMode>, customArgs: string[]): import("simple-git/dist/src/lib/types").StringTask<string>;
